...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, semantic_dim : int):
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        self._semantic_feature = torch.zeros(fused_point_cloud.shape[0], self.semantic_dim, 1).float().cuda()
    ...
    def densification_postfix(self, new_xyz, new_knn_f, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_semantic_feature):
        d = {"xyz": new_xyz,
        "knn_f": new_knn_f,
    ...
    def densify_and_split(self, grads, grad_threshold, grads_abs, grad_abs_threshold, scene_extent, max_radii2D, N=2):
        ...
        self.densification_postfix(new_xyz, new_knn_f, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation, new_semantic_feature)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        if selected_pts_mask.sum() > 0:
            ...
            self.densification_postfix(new_xyz, new_knn_f, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_semantic_feature)
