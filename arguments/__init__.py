...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.sh_degree = 3
        self.semantic_dim = 150
        self._source_path = ""
        self._model_path = ""
        self._images = "images"
        self.semantics = "segmentation_logits"
        self.depths = "pred_depths"
        self._resolution = -1
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        ###################################
        self.geo_regularization_from_iter = 1500
        self.scale_loss_weight = 100.0
        self.semantic_soft_loss_weight = 1.0
        self.semantic_hard_loss_weight = 0.1
        self.depth_loss_weight = 0.5
        self.normal_consistency_loss_weight = 0.05
        self.edge_aware_normal_loss_weight = 0.01
        ###################################
